...
function selectedProducts() {
  return (
    <div className="min-h-[1200px]  max-w-[1440px] flex justify-center">
      <div className="min-h-[858px] max-w-[955px] w-full ">
        <div className="text-center">
          <h1 className="font-[700] text-center text-[48px] text-[#E16E4E]">
            Selected Products
          </h1>
        ...
        <div className="mt-[64px] flex flex-col gap-[25px] items-center md:flex-row">
          <div className="min-h-[858px]  m-auto max-w-[465px]">
            ...
            <p className="font-[400] min-h-[254px] leading-[40px] w-full text-[18px] text-[#333333]">
          ...
          <div className="min-h-[858px]   m-auto max-w-[465px]">
            ...
            <p className="font-[400] min-h-[254px] leading-[36px] w-full text-[18px] text-[#333333]">
