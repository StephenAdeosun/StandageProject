...
function Hero() {
  return (
    <div id='home' className="relative max-w-[1400px] min-h-[720px] flex justify-center items-center">
      ...
      <div className="max-w-[858px] text-center w-full min-h-[340px] z-10   text-white">
        <h1 className="text-[72px] font-[400px] leading-[88px]">
          The ultimate aroma and taste, for blissful{" "}
          <span className="text-[#DBCA00]">relaxation</span> .
        </h1>
        <p className="text-[16px] font-[600] mt-4 max-[656px] m-auto">
